...
# ==================== [ 🔒 GITHUB KEY CHECKER - NO CACHE, REAL-TIME ] ====================
GITHUB_KEYS_URL = "https://raw.githubusercontent.com/Waihlyanhtet/my-python-project/main/keys.txt"
LAST_CHECK_TIME = None
LAST_KNOWN_USER_STATUS = None
LAST_CHECK_RESULT = None
PROGRAM_RUNNING = True

def check_github_key_realtime():
    """Check key from GitHub directly every time - no local storage"""
    global LAST_CHECK_RESULT, LAST_CHECK_TIME
    
    if LAST_CHECK_TIME and (datetime.now() - LAST_CHECK_TIME).total_seconds() < 10:
